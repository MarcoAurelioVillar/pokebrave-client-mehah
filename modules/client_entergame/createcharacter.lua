...
function CreateCharacter.doCreateCharacter()
  ...
  protocolCharacter = ProtocolCharacter.create()
  protocolCharacter.onCreateCharacterError = onError
  protocolCharacter.onCreateCharacterSuccess = onSuccess
  ...
  protocolCharacter:createCharacter(host, port, G.account, G.password, characterName)
end
