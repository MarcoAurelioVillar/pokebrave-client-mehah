...
function CreateAccount.doCreateAccount()
  ...
  protocolAccount.onCreateAccountError = onError
  protocolAccount.onCreateAccountSuccess = onSuccess

  loadBox = displayCancelBox(tr('Please wait'), tr('Connecting to create account server...'))
  connect(loadBox, { onCancel = function(msgbox)
                                  loadBox = nil
                                  protocolAccount:cancelCreateAccount()
                                  CreateAccount.show()
                                end})
  ...
  protocolAccount:createAccount(host, port, createAccountName, createEmail, createPassword, createPasswordConfirmation)
end
