...
function ProtocolAccount:createAccount(host, port, accountName, email, password, passwordConfirmation)
...
function ProtocolAccount:sendCreateAccountPacket()
