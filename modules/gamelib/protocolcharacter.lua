-- @docclass
ProtocolCharacter = extends(Protocol, "ProtocolCharacter")

function ProtocolCharacter:createCharacter(host, port, accountName, password, characterName)
...
function ProtocolCharacter:cancelCreateCharacter()
  self:disconnect()
end

function ProtocolCharacter:sendCreateCharacterPacket()
...
function ProtocolCharacter:onConnect()
  self.gotConnection = true
  self:connectCallback()
  self.connectCallback = nil
end

function ProtocolCharacter:onRecv(msg)
...
function ProtocolCharacter:parseSuccess(msg)
  local successMessage = msg:getString()
  self.onCreateCharacterSuccess(successMessage)
end

function ProtocolCharacter:parseError(msg)
